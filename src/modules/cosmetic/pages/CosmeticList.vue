    ...
    <div class="bg-soft-elevated border-b border-pink-200/30 dark:border-pink-400/20">
      <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="text-center">
          <h1 class="text-4xl font-bold text-pink-gradient mb-4">
            Sản phẩm mỹ phẩm
          </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div v-if="loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <div v-for="i in 8" :key="i" class="animate-pulse">
          <div class="bg-soft-elevated rounded-lg h-80 border border-pink-200/30 dark:border-pink-400/20"></div>
        </div>
      </div>
      ...
      <div v-else-if="error" class="text-center py-12">
        <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-8 max-w-md mx-auto">
          ...
          <UButton color="red" variant="soft" @click="loadCosmetics">
            Thử lại
          </UButton>
        </div>
      </div>
      ...
      <div v-else-if="!cosmetics.length" class="text-center py-12">
        ...
        <h3 class="text-lg font-medium text-soft-primary mb-2">
          Không tìm thấy sản phẩm
        </h3>
        <p class="text-soft-secondary mb-4">
            ...
            <div class="flex flex-col md:flex-row gap-4">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div class="flex-1">
                    <h3 class="text-lg font-semibold text-soft-primary mb-2 line-clamp-2">
                      {{ cosmetic.name }}
                    </h3>
...
// Watchers
watch([searchQuery, sortBy, priceRange, ratingFilter], () => {
  currentPage.value = 1
  loadCosmetics()
}, { debounce: 300 })
