...
import type { CosmeticCreateReq, CosmeticQueryParams, CosmeticRes, CosmeticUpdateReq, PaginatedCosmeticRes } from './cosmetic.dto'
import type { Cosmetic } from './cosmetic.types'

export const getAllCosmeticsApi = async (req: CosmeticQueryParams): Promise<PaginatedCosmeticRes> => {
...
export const updateCosmeticApi = async (id: string, cosmetic: CosmeticUpdateReq): Promise<CosmeticRes> => {
