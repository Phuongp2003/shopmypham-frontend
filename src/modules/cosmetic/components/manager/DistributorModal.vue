...
<template>
  <UModal title="{{ isEditing ? 'Sửa nhà phân phối' : 'Thêm nhà phân phối' }}" @close="handleCancel">
    <template #content>
      <div class="p-6 w-96">
        <UForm :state="form">
        ...
        <div class="flex justify-end mt-4 gap-2">
          ...
          <UButton color="primary" @click="handleSubmit">{{ isEditing ? 'Cập nhật' : 'Tạo mới' }}</UButton>
        </div>
      </div>
    </template>
  </UModal>
