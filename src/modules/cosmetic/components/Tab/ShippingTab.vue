    ...
    <div class="space-y-6">
        ...
        >
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Thời gian giao hàng: {{ shippingPolicy.deliveryTime }}
            </p>

            <div
                v-if="sortedShippingFeatures && sortedShippingFeatures.length > 0"
...
const sortedShippingFeatures = computed(() => {
    ...
    return props.shippingPolicy.features.sort((a, b) => a.orderIndex - b.orderIndex);
});
</script>
