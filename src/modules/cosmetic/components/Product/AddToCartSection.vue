<template>
    <div class="space-y-4">
        ...
        <div class="flex items-center space-x-4">
            <div
                class="flex items-center border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800"
            >
                <UButton
                ...
                />
                <span class="px-4 py-2 min-w-[3rem] text-center text-gray-900 dark:text-white">{{
                    quantity
                }}</span>
                <UButton
        ...
        <div
            v-if="activeBadges && activeBadges.length > 0"
            class="grid grid-cols-3 gap-4 text-center text-sm"
        >
            <div
            ...
            >
                <div
                    class="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mb-2"
                >
