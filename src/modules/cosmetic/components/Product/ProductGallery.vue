  ...
  <div class="space-y-4">
    ...
    >
      ...
      <div class="absolute top-4 left-4">
        <UBadge
          v-if="cosmetic?.badges?.some((badge) => badge.badgeType === 'sale' && badge.isActive)"
          color="red"
          size="sm"
        >
          SALE
        ...
        <div
          ...
          :class="{
            'ring-2 ring-pink-500 dark:ring-pink-400 shadow-lg shadow-pink-500/20':
              selectedImage === image,
            'hover:ring-1 hover:ring-pink-300 dark:hover:ring-pink-500': selectedImage !== image,
          }"
