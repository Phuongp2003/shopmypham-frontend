<template>
  <header
    ...
    style="background-color: rgba(253, 231, 243, 0.95); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);"
  >
    <div class="h-full px-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        ...
        <UButton
          ...
          color="primary"
          variant="soft"
          class="bg-pink-100/80 hover:bg-pink-200/80 dark:bg-pink-400/20 dark:hover:bg-pink-400/30 text-pink-700 dark:text-pink-300 border border-pink-200/50 dark:border-pink-400/30 transition-all duration-200 shadow-sm"
        >
          Đăng nhập
        </UButton>
      </div>
