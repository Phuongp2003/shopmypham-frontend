...
const currentLayout = computed(() => {
    ...
    if (metaData.layout)
        layoutStore.setLayoutByName(metaData.layout as 'blank' | 'admin' | 'default');
    else layoutStore.setLayoutByName('default');
    if (useAuthStore().isAuthenticated && useAuthStore().userType === 'admin')
        layoutStore.setLayoutByName('admin');
